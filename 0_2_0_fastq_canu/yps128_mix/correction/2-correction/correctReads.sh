...
if [ $jobid -gt 120 ]; then
  echo Error: Only 120 partitions, you asked for $jobid.
  exit 1
fi
...
#  Store must exist: correction/yps128.ovlStore

#  File must exist: yps128.readsToCorrect

#  File must exist: yps128.globalScores

gkpStore="../yps128.gkpStore"


$bin/falconsense \
  -G $gkpStore \
  -C ../yps128.corStore \
  -b $bgn -e $end -r ./yps128.readsToCorrect \
  -t  4 \
  -ci 0.5 \
  -cl 1000 \
  -cc 4 \
