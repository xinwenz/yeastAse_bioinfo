# input: .group.sort 
# input format: geneName, chrom. position, ref, coverage, string, quality, positionInreads, readsName
# count referce hits under the same gene name 
# output format: geneName, total ref counts, reads name.
import sys
import numpy as np
